...
"""
# ========== 导入依赖 ==========
import contact_manager.ui as ui
from contact_manager.application_lifecycle import ApplicationLifecycle  # 应用层：生命周期
from contact_manager.contact_service import ContactNotFoundError, ContactService  # 应用层：业务用例
from contact_manager.logger import Logger
from contact_manager.domain import (  # 领域层：业务异常
